        	...
        	<div class="table-responsive">
                ...
                <form class="form-group" method="post" action="<?= site_url($this->uri->segment(1).'/save')?>" enctype="multipart/form-data">
                    <table class="table table-hover">
                        <tr>
                            <td>Judul Buku</td>
                            <td><input type="text" class="form-control" name="judul_buku" placeholder="Judul Buku" required></td>
                        </tr> 
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control" name="pengarang" placeholder="Nama Pengarang" required></td>
                        </tr> 

                        <tr>
                            <td>Nama Penerbit</td>
                            <td><input type="text" class="form-control" name="penerbit" placeholder="Nama Penerbit" required></td>
                        </tr>
                        ...
                        <tr>
                            <td>ISBN</td>
                            <td>
                                <input type="text" id="isbn" class="form-control" name="isbn" placeholder="isbn" minlength="13" maxlength="13" required>
                                <input type="text" class="form-control" id="hasil_isbn" name="hasil_isbn" placeholder="format isbn" readonly required>
